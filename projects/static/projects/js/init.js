...
$(document).ready(function(){
   /*Surenjanath function init start*/
	Surenjanath();
   /*Surenjanath function init end*/
...
/***** Surenjanath function start *****/
var Surenjanath = function (){

	/*Typed js start*/
	$("#typed").typed({
		strings: ["^2100&nbsp;I Am Surenjanath.<br/>UWI Graduate with a BSC in Actuarial Science.<br/> Living in the suburban."],
		typeSpeed: 35,
		backDelay: 750,
		loop: false,
		cursorChar: "|",
